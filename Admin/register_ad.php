...
<link rel="stylesheet" href="../css/index.css"  />
  ...
  <body style="background-image: url('../image/p_background.png') !important;background-size: cover; background-repeat:no-repeat; overflow:hidden;">
    ...
    .btn{
     ...
     <!--?php include"../Dash_Home/Dash_home.php"?-->
    <form autocomplete="off" class=" m-auto 
   p-2 shadow" action="" method="post" id="myForm">
      <input type="hidden" id="action" value="register">
   <input type="hidden" id="usertype" value="admin" name="usertype">  
   <input type="hidden" name="user_profile" id="user_profile" value="avatar.png" />
  ...
  <div class="mb-3">
    ...
    <input type="tel" class="form-control" id="contact_Num" name="contact_Num" autocomplete="off" maxlength="11">
       ...
       <div class="mb-3">
    <label for="ad_position" class="form-label">Employee Position</label>
    <input type="text" class="form-control" id="ad_position" name="ad_position" autocomplete="off">
  </div>  
      <div class="mb-3">
 ...
 <button type="button" id="btn" class="btn btn-primary w-100 mb-3 me-3" onclick="Back()">Back</button>
    ...
    <br>
      <label class="linkForm ms-3">Already have account? <a href="login_ad.php">Login</a></label>
