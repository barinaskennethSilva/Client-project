  ...
  <div class="container-fluid">
   ...
   <i class="fa fa-bars"></i>
    ...
    <label class="text-white"><?php echo $user["email"];?></label>
          ...
          <ul>
      <li><a href="../view/Home.php"><i class="fa fa-home"></i><span class="ms-3">Home</span></a></li>
     <li><a href="../view/profile.php"><i class="fa fa-user"></i><span class="ms-3">profile</span></a></li>   
 <li><a href="../view/Booking_appoint.php"><i class="fa fa-tasks"></i><span class="ms-3">Booking Appointment</span></a></li>
   <li><a href="#"><i class="fa fa-tag"></i><span class="ms-3">Transaction Record</span></a></li>   
  <li><a href="message.php"><i class="fa fa-bell"></i><span class="ms-3">Message Us</span></a></li>   
  <li><a href="../Test/logout.php"><i class="fa fa-sign-out"></i><span class="ms-3">Logout</span></a></li>
     </ul> 
